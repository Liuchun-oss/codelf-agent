    ...
    build: {
      rollupOptions: {
        input: {
          ...
          overlayHud: resolve(__electron_vite_injected_dirname, "src/overlay/hud.html"),
          overlayMarquee: resolve(__electron_vite_injected_dirname, "src/overlay/marquee.html")
        }
      }
    }
  }
